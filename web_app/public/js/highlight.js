...
// rex
re = /(task|desc|user|password|pass_auth|sync|group|install|private_key|public_key|needs|service|sysctl|source|owner|group|mode|on_change|template_file|template_search_for|inject|do_task|deploy|context_path|username|port|template|file|db|select|dsn|fields|from|where|parallelism|deploy_to|document_root|generate_deploy_directory|context_path|tail|cat)\b/;
RE[6] = new RegExp(re);
...
var classes  = new Array("quotedString", "comment", "operator", "builtinVariable", "variableSpecifier", "keyword", "rex", "builtinFunction", "identifier", "number");
